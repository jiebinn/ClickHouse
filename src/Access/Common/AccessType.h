...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    \
    M(dictGet, "dictHas, dictGetHierarchy, dictGetRoot, dictIsIn", DICTIONARY, ALL) /* allows to execute functions dictGet(), dictHas(), dictGetHierarchy(), dictGetRoot(), dictIsIn() */\
