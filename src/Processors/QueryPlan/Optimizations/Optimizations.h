...
size_t tryUseVectorSearchWithVectorIndex(QueryPlan::Node * parent_node, QueryPlan::Nodes & nodes, const Optimization::ExtraSettings &);
...
inline const auto & getOptimizations()
{
    static const std::array<Optimization, 18> optimizations = {{
        ...
        {tryUseVectorSearchWithVectorIndex, "useVectorSearch", &QueryPlanOptimizationSettings::try_use_vector_search},
...
bool optimizeVectorSearchWithQuantizedCodes( QueryPlan::Node & root, Stack & stack, QueryPlan::Nodes & nodes, const Optimization::ExtraSettings & settings, size_t max_limit_for_lazy_materialization); void materializeQueryPlanReferences(QueryPlan::Node & node, QueryPlan::Nodes & nodes);
