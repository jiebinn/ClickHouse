...
# NOTE: event temporarily set to PULL_REQUEST to validate the final CFI job config
# (build + stress + integration, stateless dropped) on this fork PR head. Revert to
