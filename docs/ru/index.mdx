...
export const QuickstartPill = ({ children }) => {
    const path = '/ru/get-started/quickstarts/create-your-first-service-on-cloud';
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      <div className="flex justify-center mb-8">
            <QuickstartPill>Быстрый старт: <span className="font-medium text-[#2563eb] dark:text-[#FCFF74]">Начните работу с Cloud</span></QuickstartPill>
        </div>
      ...
      <div className="flex items-center justify-center gap-6 my-6">
        ...
        <AskAILink>Спросить ИИ</AskAILink>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Что такое ClickHouse?", href: "/ru/get-started/about/intro" },
        { label: "Установка", href: "/ru/get-started/setup/cloud" },
        { label: "Быстрый старт", href: "/ru/get-started/quickstarts/home" },
        { label: "Основные понятия ClickHouse", href: "/ru/concepts/core-concepts/index" },
        { label: "Примеры наборов данных", href: "/ru/get-started/sample-datasets/index" },
        { label: "Руководства по миграции", href: "/ru/get-started/migrate/overview" },
        { label: "Лучшие практики", href: "/ru/concepts/best-practices/index" },
    ]}
        />
        ...
        <svg width="24" height="24" viewBox="0 0 23 26" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="ch-goal-icon">
          ...
          links={[
        { label: "Моделирование данных", href: "/ru/guides/clickhouse/data-modelling/schema-design" },
        { label: "Оптимизация производительности", href: "/ru/guides/clickhouse/performance-and-monitoring/query-optimization" },
        { label: "ClickHouse Cloud", href: "/ru/products/cloud/guides" },
        { label: "Сценарии использования", href: "/ru/guides/use-cases" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Справочник SQL", href: "/ru/reference/statements" },
        { label: "Настройки", href: "/ru/reference/settings/index" },
        { label: "Функции", href: "/ru/reference/functions/regular-functions/overview" },
        { label: "Движки", href: "/ru/reference/engines/engines" },
        { label: "Системные таблицы", href: "/ru/reference/system-tables" },
        { label: "Форматы", href: "/ru/reference/formats/index" },
        { label: "Типы данных", href: "/ru/reference/data-types/index" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "chDB", href: "/ru/products/chdb" },
        { label: "ClickHouse Cloud", href: "/ru/products/cloud/getting-started/cloud-get-started" },
        { label: "ClickStack", href: "/ru/clickstack" },
        { label: "Langfuse", href: "https://langfuse.com/docs" },
        { label: "Managed Postgres", href: "/ru/products/managed-postgres/overview" },
        { label: "Kubernetes operator", href: "/ru/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "Как организовать приём данных из распространённых источников с минимальными усилиями", href: "/ru/integrations" },
              { label: "Лучшие практики организации данных для аналитики и роста", href: "/ru/guides/clickhouse/data-modelling/schema-design" },
              { label: "Способы выполнять запросы к большим датасетам в реальном времени", href: "/ru/get-started/use-cases/real-time-analytics" },
              { label: "Как создавать панели мониторинга, оповещения и событийно-ориентированные функции на платформе", href: "/ru/get-started/use-cases/data-warehousing" },
              { label: "Как снизить затраты без потери производительности", href: "/ru/concepts/best-practices/index" },
          ]}
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="Платформа LLM-инжиниринга с открытым исходным кодом для обсервабилити, метрик, оценивания и управления промптами." href="https://langfuse.com/docs" showArrow />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Оператор Kubernetes" description="Автоматизирует развертывание, настройку и управление кластерами ClickHouse и ClickHouse Keeper в Kubernetes." href="/ru/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="Быстрая, надежная и масштабируемая встраиваемая база данных. Оцените мощь ClickHouse прямо в приложении." href="/ru/products/chdb/index" showArrow />
        </div>
      </div>
