...
Перед загрузкой данных можно использовать функцию [file()](/ru/reference/functions/regular-functions/files#file), чтобы посмотреть структуру [примерного файла Parquet](/ru/assets/data.parquet):
