...
Перед загрузкой данных можно использовать функцию [file()](/ru/reference/functions/regular-functions/files#file), чтобы посмотреть структуру [примерного файла Parquet](/ruhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.parquet):
