...
Иногда для экономии места JSON‑файлы кодируют в виде массивов, а не объектов. В этом случае мы имеем дело со [списком JSON-массивов](/ru/assets/arrays.jsonl):
