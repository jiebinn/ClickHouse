...
For Managed ClickStack, the API is accessed through the **ClickHouse Cloud API**. The ClickStack endpoints are available in the [Cloud API specification](/products/cloud/api-reference/organization/get-list-of-available-organizations#tag/ClickStack).
