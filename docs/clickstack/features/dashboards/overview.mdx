...
<Image img="/images/clickstack/dashboards/number-tile-background-chart.png" alt="Display Settings drawer for a number tile, with Background chart set to Area" size="lg"/>
