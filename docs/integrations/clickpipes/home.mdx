...
| [Amazon S3](/integrations/clickpipes/object-storage/amazon-s3/overview) | <img src="/images/integrations/logos/amazon_s3_logo.svg" alt="Amazon S3 logo" width="32" />              |Object Storage| Stable           | Configure ClickPipes to ingest large volumes of data from object storage.                            |
| [Google Cloud Storage](/integrations/clickpipes/object-storage/google-cloud-storage/overview) | <img src="/images/integrations/logos/gcs.svg" alt="Google Cloud Storage logo" width="32" />  |Object Storage| Stable           | Configure ClickPipes to ingest large volumes of data from object storage.                            |
...
| [Azure Blob Storage](/integrations/clickpipes/object-storage/azure-blob-storage/overview) | <img src="/images/integrations/logos/azureblobstorage.svg" alt="Azure Blob Storage logo" width="32" /> | Object Storage | Stable | Configure ClickPipes to ingest large volumes of data from object storage.
