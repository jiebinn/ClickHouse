...
[DELETE FROM](/snippets/delete) permite ejecutar consultas DELETE estándar en ClickHouse. Las filas que coinciden con la cláusula de filtro se marcan como eliminadas y se excluyen de los conjuntos de resultados posteriores. La limpieza de las filas se realiza de forma asíncrona.
