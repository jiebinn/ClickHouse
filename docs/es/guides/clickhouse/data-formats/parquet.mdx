...
Antes de cargar los datos, podemos usar la función [file()](/es/reference/functions/regular-functions/files#file) para inspeccionar la estructura de un [archivo Parquet de ejemplo](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.parquet):
