...
Antes de cargar los datos, podemos usar la función [file()](/es/reference/functions/regular-functions/files#file) para inspeccionar la estructura de un [archivo Parquet de ejemplo](/es/assets/data.parquet):
