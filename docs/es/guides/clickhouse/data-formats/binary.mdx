...
Vamos a usar some&#95;data [tabla](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/some_data.sql) y [datos](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/some_data.tsv) para la demostración; no dudes en reproducirlo en tu instancia de ClickHouse.
...
Esto creará el archivo [data.clickhouse](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.clickhouse) en formato nativo.
...
Esto generará el archivo [data.binary](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.binary) en formato binario por filas.
...
Para importar datos de un [archivo MessagePack](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.msgpk):
...
Para trabajar con [Protocol Buffers](/es/reference/formats/Protobuf/Protobuf), primero debemos definir un [archivo de esquema](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/schema.proto):
...
Otro formato popular de serialización binaria compatible con ClickHouse es [Cap&#39;n Proto](https://capnproto.org/). Al igual que con el formato `Protobuf`, en nuestro ejemplo tenemos que definir un archivo de esquema ([`schema.capnp`](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/schema.capnp)):
