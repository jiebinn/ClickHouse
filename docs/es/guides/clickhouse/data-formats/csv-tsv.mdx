...
Para importar datos del [archivo CSV](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data_small.csv) a la tabla `sometable`, podemos pasar el archivo directamente a `clickhouse-client` mediante una tubería:
...
Supongamos que nuestro [archivo CSV incluye encabezados](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data_small_headers.csv):
...
El [archivo](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data_small.csv) tiene 1k filas, pero ClickHouse solo cargó 990, ya que le indicamos que omitiera las primeras 10.
...
El formato de datos separados por tabuladores se utiliza ampliamente como formato de intercambio de datos. Para cargar datos desde un [archivo TSV](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data_small.tsv) en ClickHouse, se utiliza el formato [TabSeparated](/es/reference/formats/TabSeparated/TabSeparated):
...
Ahora podemos cargar datos desde nuestro [archivo con formato personalizado](/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data_small_custom.txt):
