...
Una consulta de [eliminación ligera](/snippets/delete) puede ejecutarse como una actualización ligera `UPDATE` en lugar de una mutación `ALTER UPDATE`. La implementación de la eliminación ligera se controla mediante el ajuste [`lightweight_delete_mode`](/es/reference/settings/session-settings#lightweight_delete_mode).
...
* [eliminación ligera](/snippets/delete) - Operaciones de eliminación ligera con `DELETE`
