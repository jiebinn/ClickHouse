...
<Steps>
  <Step>
    #### <TrackedLink href={'/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/temporal-metrics-dashboard.json'} download="temporal-metrics-dashboard.json" eventName="docs.temporal_metrics_monitoring.dashboard_download">Descargar</TrackedLink> la configuración del dashboard
  </Step>
