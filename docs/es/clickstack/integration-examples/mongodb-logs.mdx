...
<Steps>
  <Step>
    #### <TrackedLink href={'/eshttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/mongodb-logs-dashboard.json'} download="mongodb-logs-dashboard.json" eventName="docs.mongodb_logs_monitoring.dashboard_download">Descargar</TrackedLink> la configuración del dashboard
  </Step>
