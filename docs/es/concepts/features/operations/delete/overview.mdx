...
Tenga en cuenta que en esta operación se utiliza una mutación para [marcar las filas eliminadas](/es/snippets/delete#how-lightweight-deletes-work-internally-in-clickhouse) (añadiendo una columna `_row_exists`), lo que genera cierta E/S.
