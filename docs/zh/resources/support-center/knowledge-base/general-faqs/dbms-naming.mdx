...
它是由 “**Click**stream” 和 “Data ware**House**” 组合而成的。这个名字源于 Yandex.Metrica 最初的使用场景：ClickHouse 原本用于保存来自全球互联网用户的所有点击记录，而且直到今天仍然胜任这项工作。你可以在 [ClickHouse 历史](../../about-us/history.md) 页面了解这一使用场景的更多信息。
