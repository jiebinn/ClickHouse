...
<Frame caption="图 1：ClickHouse 时间线。">
  <img src="/images/managing-data/core-concepts/_vldb2024_1_Figure_0.png" alt="图 1：ClickHouse 时间线。" />
</Frame>
...
<Frame caption="图 2：ClickHouse 数据库引擎的高层架构。">
  <img src="/images/managing-data/core-concepts/_vldb2024_2_Figure_0.png" alt="图 2：ClickHouse 数据库引擎的高层架构。" />
</Frame>
...
<Frame caption="图 3：MergeTree\* 引擎表的插入与合并。">
  <img src="/images/managing-data/core-concepts/_vldb2024_2_Figure_5.png" alt="图 3：MergeTree*-engine 表的插入与合并。" />
</Frame>
...
<Frame caption="图 4：使用主键索引评估过滤器。">
  <img src="/images/managing-data/core-concepts/_vldb2024_3_Figure_7.png" alt="图 4：使用主键索引评估过滤器。" />
</Frame>
...
<Frame caption="图 5：materialized view 中的聚合合并。">
  <img src="/images/managing-data/core-concepts/_vldb2024_4_Figure_6.png" alt="Figure 5: Aggregating merges in materialized views." />
</Frame>
...
<Frame caption="图 6：三节点集群中的复制。">
  <img src="/images/managing-data/core-concepts/_vldb2024_5_Figure_8.png" alt="图 6：三节点集群中的复制。" />
</Frame>
...
<Frame caption="图 7：跨 SIMD 单元、核心和节点的并行化。">
  <img src="/images/managing-data/core-concepts/_vldb2024_6_Figure_0.png" alt="图 7：跨 SIMD 单元、核心和节点的并行化。" />
</Frame>
...
<Frame caption="图 8：具有三条执行通道的物理算子计划。">
  <img src="/images/managing-data/core-concepts/_vldb2024_7_Figure_1.png" alt="图 8：具有三条执行通道的物理算子计划。" />
</Frame>
...
<Frame caption="图 9：包含三个哈希表分区的并行 hash join。">
  <img src="/images/managing-data/core-concepts/_vldb2024_8_Figure_7.png" alt="图 9：包含三个哈希表分区的并行 hash join。" />
</Frame>
...
<Frame caption="附加图：ClickBench 的互操作选项。">
  <img src="/images/managing-data/core-concepts/_vldb2024_10_Figure_14.png" alt="附加图：ClickBench 的互操作选项。" />
</Frame>
...
<Frame caption="图 10：ClickBench 的相对冷运行时间和热态运行时间。">
  <img src="/images/managing-data/core-concepts/_vldb2024_10_Figure_0.png" alt="图 10：ClickBench 的相对冷运行时间和热态运行时间。" />
</Frame>
...
<Frame caption="图 11：VersionsBench 2018-2024 的相对热态运行时间。">
  <img src="/images/managing-data/core-concepts/_vldb2024_10_Figure_12.png" alt="图 11：VersionsBench 2018-2024 的相对热态运行时间。" />
</Frame>
...
<Frame caption="图 12：TPC-H 查询的热态运行时间（单位：秒）。">
  <img src="/images/managing-data/core-concepts/_vldb2024_10_Figure_13.png" alt="图 12：TPC-H 查询的热态运行时间（单位：秒）。" />
</Frame>
