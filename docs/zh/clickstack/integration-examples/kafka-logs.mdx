...
<Steps>
  <Step>
    #### <TrackedLink href={'/zhhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/kafka-logs-dashboard.json'} download="kafka-logs-dashboard.json" eventName="docs.kafka_logs_monitoring.dashboard_download">下载</TrackedLink> 仪表盘配置
  </Step>
