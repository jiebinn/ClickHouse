...
export const QuickstartPill = ({ children }) => {
    const path = '/zh/get-started/quickstarts/create-your-first-service-on-cloud';
    ...
    return (
        <Tabs>
            <Tab title="Claude Code" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claudecode-color.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">在终端中运行:</p>
            ...
            <Tab title="Claude Desktop" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claude.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">添加到 <code>claude_desktop_config.json</code>:</p>
            ...
            <Tab title="Cursor" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-cursor.png">
                <p className="mb-2 text-[#9ca3af] text-[13px]">添加到 <code>.cursor/mcp.json</code>:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
            <Tab title="Windsurf" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-windsurf.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">添加到 <code>~/.codeium/windsurf/mcp_config.json</code>:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
        </Tabs>
    );
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "什么是 ClickHouse？", href: "/zh/get-started/about/intro" },
        { label: "安装", href: "/zh/get-started/setup/cloud" },
        { label: "快速入门", href: "/zh/get-started/quickstarts/home" },
        { label: "ClickHouse 概念", href: "/zh/concepts/core-concepts/index" },
        { label: "示例数据集", href: "/zh/get-started/sample-datasets/index" },
        { label: "迁移指南", href: "/zh/get-started/migrate/overview" },
        { label: "最佳实践", href: "/zh/concepts/best-practices/index" },
    ]}
        />
        ...
        <svg width="24" height="24" viewBox="0 0 23 26" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="ch-goal-icon">
          ...
          links={[
        { label: "数据建模", href: "/zh/guides/clickhouse/data-modelling/schema-design" },
        { label: "性能优化", href: "/zh/guides/clickhouse/performance-and-monitoring/query-optimization" },
        { label: "ClickHouse Cloud", href: "/zh/products/cloud/guides" },
        { label: "使用场景", href: "/zh/guides/use-cases" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "SQL 参考", href: "/zh/reference/statements" },
        { label: "设置", href: "/zh/reference/settings/index" },
        { label: "函数", href: "/zh/reference/functions/regular-functions/overview" },
        { label: "引擎", href: "/zh/reference/engines/engines" },
        { label: "系统表", href: "/zh/reference/system-tables" },
        { label: "格式", href: "/zh/reference/formats/index" },
        { label: "数据类型", href: "/zh/reference/data-types/index" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "chDB", href: "/zh/products/chdb" },
        { label: "ClickHouse Cloud", href: "/zh/products/cloud/getting-started/cloud-get-started" },
        { label: "ClickStack", href: "/zh/clickstack" },
        { label: "Langfuse", href: "https://langfuse.com/docs" },
        { label: "Managed Postgres", href: "/zh/products/managed-postgres/overview" },
        { label: "Kubernetes operator", href: "/zh/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "如何以最少工作量从常见来源摄取数据", href: "/zh/integrations" },
              { label: "面向分析和增长场景组织数据的最佳实践", href: "/zh/guides/clickhouse/data-modelling/schema-design" },
              { label: "实时查询大型数据集的方法", href: "/zh/get-started/use-cases/real-time-analytics" },
              { label: "如何在此基础上构建仪表盘、告警和事件驱动功能", href: "/zh/get-started/use-cases/data-warehousing" },
              { label: "在保持高性能的同时控制成本的技巧", href: "/zh/concepts/best-practices/index" },
          ]}
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="面向可观测性、指标、评估和提示词管理的开源 LLM 工程平台。" href="https://langfuse.com/docs" showArrow />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Kubernetes Operator" description="在 Kubernetes 上自动化部署、配置和管理 ClickHouse 与 ClickHouse Keeper 集群。" href="/zh/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="快速、可靠且可扩展的进程内数据库。在进程内体验 ClickHouse 的强大能力。" href="/zh/products/chdb/index" showArrow />
        </div>
      </div>
