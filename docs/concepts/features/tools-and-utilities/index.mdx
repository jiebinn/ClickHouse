...
| [clickhouse-static-files-disk-uploader](/concepts/features/tools-and-utilities/static-files-disk-uploader) | Prepares a data directory for a table backed by the `web` disk.|
