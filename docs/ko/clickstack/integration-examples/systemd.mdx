...
<Steps>
  <Step>
    #### <TrackedLink href={'/kohttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/systemd-logs-dashboard.json'} download="systemd-logs-dashboard.json" eventName="docs.systemd_logs_monitoring.dashboard_download">다운로드</TrackedLink>할 대시보드 구성 파일
  </Step>
