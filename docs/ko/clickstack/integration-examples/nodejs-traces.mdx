...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/nodejs/traces-search-view.webp" alt="트레이스 검색 보기" />

    <Image img="/images/clickstack/nodejs/trace-view.webp" alt="개별 트레이스 보기" />
...
<Steps>
  <Step>
    #### <TrackedLink href={'/kohttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/nodejs-traces-dashboard.json'} download="nodejs-traces-dashboard.json" eventName="docs.node_traces_monitoring.dashboard_download">다운로드</TrackedLink> 대시보드 구성
  </Step>
