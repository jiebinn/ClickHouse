...
<Steps>
  <Step>
    #### <TrackedLink href={'/kohttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/redis-logs-dashboard.json'} download="redis-logs-dashboard.json" eventName="docs.redis_logs_monitoring.dashboard_download">다운로드</TrackedLink>할 대시보드 구성 파일
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-import-dashboard.webp" alt="가져오기 완료" />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/clickstack/redis/redis-logs-dashboard.webp" alt="예시 대시보드" />
  </Step>
</Steps>
