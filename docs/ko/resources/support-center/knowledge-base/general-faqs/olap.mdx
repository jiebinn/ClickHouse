...
* 분석 보고서를 효율적으로 작성하려면 컬럼을 개별적으로 읽을 수 있어야 하므로, 대부분의 OLAP 데이터베이스는 [열 지향](/ko/es/resources/support-center/knowledge-base/general-faqs/columnar-database) 구조를 사용합니다.
