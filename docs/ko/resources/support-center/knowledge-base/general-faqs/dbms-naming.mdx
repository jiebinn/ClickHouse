...
이 이름은 &quot;**Click**stream&quot;과 &quot;Data ware**House**&quot;를 결합한 것입니다. 이는 Yandex.Metrica의 원래 사용 사례에서 유래했습니다. 당시 ClickHouse는 인터넷 전역 사용자들의 모든 클릭 기록을 저장하기 위해 만들어졌으며, 지금도 그 역할을 수행하고 있습니다. 이 사용 사례에 관한 자세한 내용은 [ClickHouse history](../../about-us/history.md) 페이지에서 확인할 수 있습니다.
