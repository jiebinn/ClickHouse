...
export const QuickstartPill = ({ children }) => {
    const path = '/ko/get-started/quickstarts/create-your-first-service-on-cloud';
    ...
    return (
        <Tabs>
            <Tab title="Claude Code" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claudecode-color.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">터미널에서 실행:</p>
            ...
            <Tab title="Claude Desktop" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claude.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]"><code>claude_desktop_config.json</code>에 추가:</p>
            ...
            <Tab title="Cursor" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-cursor.png">
                <p className="mb-2 text-[#9ca3af] text-[13px]"><code>.cursor/mcp.json</code>에 추가:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
            <Tab title="Windsurf" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-windsurf.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]"><code>~/.codeium/windsurf/mcp_config.json</code>에 추가:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
        </Tabs>
    );
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      <div className="flex justify-center mb-8">
            <QuickstartPill>빠른 시작: <span className="font-medium text-[#2563eb] dark:text-[#FCFF74]">Cloud 시작하기</span></QuickstartPill>
        </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "ClickHouse란?", href: "/ko/get-started/about/intro" },
        { label: "설치", href: "/ko/get-started/setup/cloud" },
        { label: "빠른 시작", href: "/ko/get-started/quickstarts/home" },
        { label: "ClickHouse 개념", href: "/ko/concepts/core-concepts/index" },
        { label: "예제 데이터셋", href: "/ko/get-started/sample-datasets/index" },
        { label: "마이그레이션 가이드", href: "/ko/get-started/migrate/overview" },
        { label: "모범 사례", href: "/ko/concepts/best-practices/index" },
    ]}
        />
        ...
        <svg width="24" height="24" viewBox="0 0 23 26" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="ch-goal-icon">
          ...
          links={[
        { label: "데이터 모델링", href: "/ko/guides/clickhouse/data-modelling/schema-design" },
        { label: "성능 최적화", href: "/ko/guides/clickhouse/performance-and-monitoring/query-optimization" },
        { label: "ClickHouse Cloud", href: "/ko/products/cloud/guides" },
        { label: "사용 사례", href: "/ko/guides/use-cases" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "SQL reference", href: "/ko/reference/statements" },
        { label: "Settings", href: "/ko/reference/settings/index" },
        { label: "Functions", href: "/ko/reference/functions/regular-functions/overview" },
        { label: "Engines", href: "/ko/reference/engines/engines" },
        { label: "System tables", href: "/ko/reference/system-tables" },
        { label: "Formats", href: "/ko/reference/formats/index" },
        { label: "Data types", href: "/ko/reference/data-types/index" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "chDB", href: "/ko/products/chdb" },
        { label: "ClickHouse Cloud", href: "/ko/products/cloud/getting-started/cloud-get-started" },
        { label: "ClickStack", href: "/ko/clickstack" },
        { label: "Langfuse", href: "https://langfuse.com/docs" },
        { label: "Managed Postgres", href: "/ko/products/managed-postgres/overview" },
        { label: "Kubernetes operator", href: "/ko/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              links={[
              { label: "일반적인 소스에서 최소한의 작업으로 데이터를 수집하는 방법", href: "/ko/integrations" },
              { label: "분석과 성장을 위한 데이터 구성 모범 사례", href: "/ko/guides/clickhouse/data-modelling/schema-design" },
              { label: "대규모 데이터셋을 실시간으로 쿼리하는 방법", href: "/ko/get-started/use-cases/real-time-analytics" },
              { label: "그 위에 대시보드, 알림, 이벤트 기반 기능을 구축하는 방법", href: "/ko/get-started/use-cases/data-warehousing" },
              { label: "성능은 높게 유지하면서 비용은 낮추기 위한 팁", href: "/ko/concepts/best-practices/index" },
          ]}
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="관측성, 메트릭, 평가, 프롬프트 관리를 위한 오픈 소스 LLM 엔지니어링 플랫폼입니다." href="https://langfuse.com/docs" showArrow />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Kubernetes Operator" description="Kubernetes에서 ClickHouse 및 ClickHouse Keeper 클러스터의 배포, 구성, 관리를 자동화합니다." href="/ko/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="빠르고 안정적이며 확장 가능한 인프로세스 데이터베이스입니다. 인프로세스 환경에서 ClickHouse의 강력함을 경험해 보세요." href="/ko/products/chdb/index" showArrow />
        </div>
      </div>
