...
ClickHouse 22.8에서는 [경량한 삭제](/snippets/delete)가 도입되었고, ClickHouse 25.7에서는 [경량 업데이트](/ko/reference/statements/update)가 도입되었습니다. 이러한 기능의 도입으로 비동기적으로 구체화되더라도 단일 업데이트 쿼리로 인한 변경 사항은 사용자 관점에서 즉시 반영됩니다.
