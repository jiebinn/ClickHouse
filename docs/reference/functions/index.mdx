...
| [User Defined Functions](/reference/functions/regular-functions/udf)             | Custom executable functions defined by the user.                                                       |
| [WebAssembly UDF](/reference/functions/regular-functions/wasm_udf)               | User-defined functions implemented with WebAssembly.                                                   |
