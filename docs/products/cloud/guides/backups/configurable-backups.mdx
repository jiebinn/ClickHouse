...
<Image img="/images/cloud/manage/backup-settings.png" size="lg" alt="Configure backup settings" border/>
...
<Image img="/images/cloud/manage/backup-configuration-form.png" size="lg" alt="Select backup retention and frequency" border/>
