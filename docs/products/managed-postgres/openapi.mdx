...
[pg-openapi]: /products/cloud/api-reference/organization/get-list-of-available-organizations#tag/Postgres
  "OpenAPI spec for ClickHouse Cloud: Postgres"
[list API]: /products/cloud/api-reference/organization/get-list-of-available-organizations#tag/Postgres/operation/postgresServiceGetList
  "Fetch a list of an organization's Postgres services"
[create API]: /products/cloud/api-reference/organization/get-list-of-available-organizations#tag/Postgres/operation/postgresServiceCreate
  "Create new Postgres service"
[psql]: https://www.postgresql.org/docs/current/app-psql.html
  "PostgreSQL Docs: psql — PostgreSQL interactive terminal"
[patch API]: /products/cloud/api-reference/organization/get-list-of-available-organizations#tag/Postgres/operation/postgresServicePatch
...
[config API]: /products/cloud/api-reference/organization/get-list-of-available-organizations#tag/Postgres/operation/postgresServiceSetConfig
  "Update a Postgres Service configuration"
[delete API]: /products/cloud/api-reference/organization/get-list-of-available-organizations#tag/Postgres/operation/postgresServiceDelete
...
[slow patterns API]: /products/cloud/api-reference/organization/get-list-of-available-organizations#tag/Postgres/operation/slowQueryPatternsGetList
  "List Postgres slow query patterns"
[slow pattern API]: /products/cloud/api-reference/organization/get-list-of-available-organizations#tag/Postgres/operation/slowQueryPatternGet
