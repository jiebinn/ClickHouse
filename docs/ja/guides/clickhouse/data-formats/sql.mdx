...
これで、[dump.sql](/jahttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/dump.sql) ファイルを別のOLTPデータベースに読み込ませることができます:
