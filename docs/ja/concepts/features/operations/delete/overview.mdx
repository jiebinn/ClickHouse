...
この操作では、削除された行を[マークする](/ja/snippets/delete#how-lightweight-deletes-work-internally-in-clickhouse) (`_row_exists` カラムを追加する) ためにミューテーションが使用されるため、一定の I/O が発生する点に注意してください。
