...
<Steps>
  <Step>
    #### <TrackedLink href={'/jahttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/mongodb-logs-dashboard.json'} download="mongodb-logs-dashboard.json" eventName="docs.mongodb_logs_monitoring.dashboard_download">ダウンロード</TrackedLink>してダッシュボード設定を取得します
  </Step>
