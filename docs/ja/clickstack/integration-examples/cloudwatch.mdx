...
<Steps>
  <Step>
    #### ダッシュボード設定を<TrackedLink href={'/jahttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">ダウンロード</TrackedLink>する
  </Step>
