...
export const QuickstartPill = ({ children }) => {
    const path = '/ja/get-started/quickstarts/create-your-first-service-on-cloud';
    ...
    return (
        <Tabs>
            <Tab title="Claude Code" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claudecode-color.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">ターミナルで実行:</p>
            ...
            <Tab title="Claude Desktop" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claude.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]"><code>claude_desktop_config.json</code> に追加:</p>
            ...
            <Tab title="Cursor" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-cursor.png">
                <p className="mb-2 text-[#9ca3af] text-[13px]"><code>.cursor/mcp.json</code> に追加:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
            <Tab title="Windsurf" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-windsurf.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]"><code>~/.codeium/windsurf/mcp_config.json</code> に追加:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
        </Tabs>
    );
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      <div className="flex justify-center mb-8">
            <QuickstartPill>クイックスタート: <span className="font-medium text-[#2563eb] dark:text-[#FCFF74]">Cloud をはじめる</span></QuickstartPill>
        </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "ClickHouse とは？", href: "/ja/get-started/about/intro" },
        { label: "インストール", href: "/ja/get-started/setup/cloud" },
        { label: "クイックスタート", href: "/ja/get-started/quickstarts/home" },
        { label: "ClickHouse の基本概念", href: "/ja/concepts/core-concepts/index" },
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "chDB", href: "/ja/products/chdb" },
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              { label: "分析と成長のためにデータを整理するベストプラクティス", href: "/ja/guides/clickhouse/data-modelling/schema-design" },
              { label: "大規模なデータセットをリアルタイムでクエリする方法", href: "/ja/get-started/use-cases/real-time-analytics" },
              { label: "ダッシュボード、アラート、イベント駆動型機能を構築する方法", href: "/ja/get-started/use-cases/data-warehousing" },
              { label: "高いパフォーマンスを維持しながらコストを抑えるためのヒント", href: "/ja/concepts/best-practices/index" },
          ]}
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="オープンソースの LLM エンジニアリングプラットフォーム。オブザーバビリティ、メトリクス、評価、プロンプト管理に対応しています。" href="https://langfuse.com/docs" showArrow />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Kubernetes Operator" description="Kubernetes 上で ClickHouse および ClickHouse Keeper クラスターのデプロイ、設定、管理を自動化します。" href="/ja/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="高速で信頼性が高く、スケーラブルなインプロセスデータベース。インプロセスで ClickHouse のパワーを体感できます。" href="/ja/products/chdb/index" showArrow />
        </div>
      </div>
