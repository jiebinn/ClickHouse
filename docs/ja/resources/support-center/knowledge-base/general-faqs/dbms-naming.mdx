...
これは「**Click**stream」と「Data ware**House**」を組み合わせた名前です。もともとは Yandex.Metrica のユースケースに由来しており、ClickHouse はインターネット中のあらゆるユーザーのクリック記録を保持することを想定して作られました。そして現在でも、その役割を果たし続けています。このユースケースについて詳しくは、[ClickHouse history](../../about-us/history.md) ページをご覧ください。
