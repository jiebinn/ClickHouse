...
- `nav-icon-preload.js` — warms the small desktop navbar dropdown SVGs at low priority after the initial page load so icons are ready before their menus are first opened.
