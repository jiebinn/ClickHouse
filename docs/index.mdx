            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
                <div className="col-span-2">
                    <HeroCard
                        ...
                        links={[
                            { label: "1. How to ingest data from common sources with minimal work", href: "/integrations" },
                            { label: "2. Best practices for organizing data for analytics and growth", href: "/guides/clickhouse/data-modelling/schema-design" },
                            { label: "3. Ways to query large datasets in real time", href: "/get-started/use-cases/real-time-analytics" },
                            { label: "4. How to build dashboards, alerts, and event-driven features on top", href: "/get-started/use-cases/data-warehousing" },
                            { label: "5. Tips to keep costs low while performance stays high", href: "/concepts/best-practices/index" },
                        ]}
                    />
                </div>
            ...
            <div className="mt-6">
                <Tabs>
                    ...
                    <Tab title="Claude Desktop" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claude.svg">
                        ...
                        <CodeBlock language="json">{mcpJsonConfig}</CodeBlock>
                    </Tab>
