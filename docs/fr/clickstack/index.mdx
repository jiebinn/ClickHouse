...
export const INFRA = [
  ...
  { title: 'Logs d’hôte',     img: '/images/logo-hostlogs.svg',            href: '/clickstack/integration-examples/host-logs' },
  { title: 'Systemd',       img: '/images/systemd-logomark.svg',               href: '/clickstack/integration-examples/systemd' },
  { title: 'Métriques JVM',   img: '/images/logo-java.svg',                 href: '/clickstack/integration-examples/jvm-metrics' },
  { title: 'Traces Node.js',img: '/images/logo-nodejs.svg',               href: '/clickstack/integration-examples/nodejs-traces' },
];

export const DATABASES = [
  { title: 'Logs PostgreSQL',    img: '/images/logo-postgres.svg',  href: '/clickstack/integration-examples/postgres-logs' },
  { title: 'Métriques PostgreSQL', img: '/images/logo-postgres.svg',  href: '/clickstack/integration-examples/postgres-metrics' },
  { title: 'MySQL',              img: '/images/logo-mysql.svg',     href: '/clickstack/integration-examples/mysql' },
  { title: 'Logs Redis',         img: '/images/icons/redis-logo.svg',          href: '/clickstack/integration-examples/redis-logs' },
  { title: 'Métriques Redis',      img: '/images/icons/redis-logo.svg',          href: '/clickstack/integration-examples/redis-metrics' },
  { title: 'MongoDB',            img: '/images/mongodb-logo.svg',        href: '/clickstack/integration-examples/mongodb-logs' },
  { title: 'Logs Kafka',         img: '/images/kafka-logo.svg',  darkImg: '/images/kafka-logo-dark.svg',  href: '/clickstack/integration-examples/kafka-logs' },
  { title: 'Métriques Kafka',      img: '/images/kafka-logo.svg',  darkImg: '/images/kafka-logo-dark.svg',  href: '/clickstack/integration-examples/kafka-metrics' },
  { title: 'Logs Nginx',         img: '/images/logo-nginx.svg',     href: '/clickstack/integration-examples/nginx-logs' },
  { title: 'Traces Nginx',       img: '/images/logo-nginx.svg',     href: '/clickstack/integration-examples/nginx-traces' },
