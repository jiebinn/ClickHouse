...
<Steps>
  ...
  <Step>
    ...
    <TrackedLink href={'/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/cloudwatch-logs-dashboard.json'} download="cloudwatch-logs-dashboard.json" eventName="docs.cloudwatch_logs_monitoring.dashboard_download">Télécharger `cloudwatch-logs-dashboard.json`</TrackedLink>, puis, dans la ClickStack UI, accédez à **Dashboards** et cliquez sur **Import**.
