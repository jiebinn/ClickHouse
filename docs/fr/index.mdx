...
export const QuickstartPill = ({ children }) => {
    const path = '/fr/get-started/quickstarts/create-your-first-service-on-cloud';
    ...
    return (
        <Tabs>
            <Tab title="Claude Code" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claudecode-color.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">Exécutez dans votre terminal :</p>
            ...
            <Tab title="Claude Desktop" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claude.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">Ajoutez à <code>claude_desktop_config.json</code> :</p>
            ...
            <Tab title="Cursor" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-cursor.png">
                <p className="mb-2 text-[#9ca3af] text-[13px]">Ajoutez à <code>.cursor/mcp.json</code> :</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
            <Tab title="Windsurf" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-windsurf.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">Ajoutez à <code>~/.codeium/windsurf/mcp_config.json</code> :</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
        </Tabs>
    );
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Qu’est-ce que ClickHouse ?", href: "/fr/get-started/about/intro" },
        { label: "Installation", href: "/fr/get-started/setup/cloud" },
        { label: "Guides de démarrage rapide", href: "/fr/get-started/quickstarts/home" },
        { label: "Concepts ClickHouse", href: "/fr/concepts/core-concepts/index" },
        { label: "Jeux de données d’exemple", href: "/fr/get-started/sample-datasets/index" },
        { label: "Guides de migration", href: "/fr/get-started/migrate/overview" },
        { label: "Bonnes pratiques", href: "/fr/concepts/best-practices/index" },
    ]}
        />
        ...
        <svg width="24" height="24" viewBox="0 0 23 26" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="ch-goal-icon">
          ...
          links={[
        { label: "Modélisation des données", href: "/fr/guides/clickhouse/data-modelling/schema-design" },
        { label: "Optimisation des performances", href: "/fr/guides/clickhouse/performance-and-monitoring/query-optimization" },
        { label: "ClickHouse Cloud", href: "/fr/products/cloud/guides" },
        { label: "Cas d’usage", href: "/fr/guides/use-cases" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "Référence SQL", href: "/fr/reference/statements" },
        { label: "Paramètres", href: "/fr/reference/settings/index" },
        { label: "Fonctions", href: "/fr/reference/functions/regular-functions/overview" },
        { label: "Moteurs", href: "/fr/reference/engines/engines" },
        { label: "Tables système", href: "/fr/reference/system-tables" },
        { label: "Formats", href: "/fr/reference/formats/index" },
        { label: "Types de données", href: "/fr/reference/data-types/index" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "chDB", href: "/fr/products/chdb" },
        { label: "ClickHouse Cloud", href: "/fr/products/cloud/getting-started/cloud-get-started" },
        { label: "ClickStack", href: "/fr/clickstack" },
        { label: "Langfuse", href: "https://langfuse.com/docs" },
        { label: "Managed Postgres", href: "/fr/products/managed-postgres/overview" },
        { label: "Operator Kubernetes", href: "/fr/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              { label: "Bonnes pratiques pour organiser les données au service de l’analytics et de la croissance", href: "/fr/guides/clickhouse/data-modelling/schema-design" },
              { label: "Comment interroger de grands jeux de données en temps réel", href: "/fr/get-started/use-cases/real-time-analytics" },
              { label: "Comment créer des dashboards, des alertes et des fonctionnalités pilotées par les événements", href: "/fr/get-started/use-cases/data-warehousing" },
              { label: "Conseils pour maîtriser les coûts sans compromettre les performances", href: "/fr/concepts/best-practices/index" },
          ]}
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="Plateforme open-source d’ingénierie LLM pour l’observabilité, les métriques, les évaluations et la gestion des prompts." href="https://langfuse.com/docs" showArrow />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Opérateur Kubernetes" description="Automatise le déploiement, la configuration et la gestion des clusters ClickHouse et ClickHouse Keeper sur Kubernetes." href="/fr/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="Une base de données in-process rapide, fiable et évolutive. Découvrez la puissance de ClickHouse en mode in-process." href="/fr/products/chdb/index" showArrow />
        </div>
      </div>
