...
<Frame caption="Découvrez la ClickHouse Academy pour des formations à la demande et en direct">
  <a href="https://learn.clickhouse.com/" target="_blank">
    <img src="/images/academy.png" alt="ClickHouse Academy — Maîtrisez ClickHouse grâce à des formations conçues par des experts, pour tous les niveaux" width="560" noZoom />
  </a>
</Frame>