...
Pour importer des données depuis le [fichier CSV](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data_small.csv) vers la table `sometable`, nous pouvons rediriger notre fichier directement vers clickhouse-client :
...
Supposons que notre [fichier CSV comporte des en-têtes](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data_small_headers.csv) :
...
Le [fichier](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data_small.csv) contient 1k lignes, mais ClickHouse n’en a chargé que 990, car nous avons demandé à ignorer les 10 premières.
...
Le format de données séparées par des tabulations est couramment utilisé comme format d’échange de données. Pour charger des données depuis un [fichier TSV](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data_small.tsv) dans ClickHouse, on utilise le format [TabSeparated](/fr/reference/formats/TabSeparated/TabSeparated) :
...
Nous pouvons maintenant charger des données à partir de notre [fichier](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data_small_custom.txt) au format personnalisé :
