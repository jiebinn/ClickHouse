...
Avant de charger les données, nous pouvons utiliser la fonction [file()](/fr/reference/functions/regular-functions/files#file) pour examiner la structure d’un [fichier Parquet d’exemple](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.parquet) :
