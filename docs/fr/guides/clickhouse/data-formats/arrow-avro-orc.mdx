...
Pour importer à partir d’un [fichier Avro](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.avro), il faut utiliser le format [Avro](/fr/reference/formats/Avro/Avro) dans l’instruction `INSERT` :
...
Un autre format colonnaire est [Apache Arrow](https://arrow.apache.org/), également pris en charge par ClickHouse pour l’importation et l’exportation. Pour importer des données à partir d’un [fichier Arrow](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.arrow), nous utilisons le format [Arrow](/fr/reference/formats/Arrow/Arrow) :
