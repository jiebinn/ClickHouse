...
Nous pouvons maintenant charger le fichier [dump.sql](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/dump.sql) dans une autre base de données OLTP :
