...
Nous allons utiliser la table some&#95;data [table](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/some_data.sql) et les [données](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/some_data.tsv) pour cette démonstration ; n’hésitez pas à reproduire cela sur votre instance ClickHouse.
...
Cela créera le fichier [data.clickhouse](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.clickhouse) au format Native.
...
Cela génère le fichier [data.binary](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.binary) au format binaire par lignes.
...
Pour importer des données à partir d’un [fichier MessagePack](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.msgpk) :
...
Pour travailler avec [Protocol Buffers](/fr/reference/formats/Protobuf/Protobuf), nous devons d’abord définir un [fichier de schéma](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/schema.proto) :
...
Un autre format de sérialisation binaire populaire pris en charge par ClickHouse est [Cap&#39;n Proto](https://capnproto.org/). Comme avec le format `Protobuf`, nous devons définir un fichier de schéma ([`schema.capnp`](/frhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/schema.capnp)) dans notre exemple :
