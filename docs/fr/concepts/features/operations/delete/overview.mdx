...
Notez qu’une mutation est utilisée dans cette opération pour [marquer les lignes supprimées](/fr/snippets/delete#how-lightweight-deletes-work-internally-in-clickhouse) (en ajoutant une colonne `_row_exists`), ce qui entraîne donc des E/S.
