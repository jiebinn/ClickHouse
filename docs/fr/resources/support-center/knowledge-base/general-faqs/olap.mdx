...
* Pour produire efficacement des rapports analytiques, il est essentiel de pouvoir lire les colonnes séparément ; c&#39;est pourquoi la plupart des bases de données OLAP sont [orientées colonnes](/fr/es/resources/support-center/knowledge-base/general-faqs/columnar-database),
