...
É uma combinação de &quot;**Click**stream&quot; e &quot;Data ware**House**&quot;. O nome vem do caso de uso original no Yandex.Metrica, em que o ClickHouse deveria armazenar registros de todos os cliques feitos por pessoas de toda a Internet — e ainda cumpre essa função. Você pode ler mais sobre esse caso de uso na página [história do ClickHouse](../../about-us/history.md).
