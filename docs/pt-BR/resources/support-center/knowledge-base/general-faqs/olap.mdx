...
* Para gerar relatórios analíticos com eficiência, é crucial conseguir ler colunas separadamente; por isso, a maioria dos bancos de dados OLAP é [colunar](/pt-BR/es/resources/support-center/knowledge-base/general-faqs/columnar-database),
