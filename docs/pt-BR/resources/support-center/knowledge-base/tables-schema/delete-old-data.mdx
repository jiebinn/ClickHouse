...
[DELETE FROM](/snippets/delete) permite executar consultas DELETE padrão no ClickHouse. As linhas selecionadas na cláusula de filtro são marcadas como excluídas e removidas de futuros conjuntos de resultados. A limpeza dessas linhas ocorre de forma assíncrona.
