...
Observe que uma mutação é usada na operação para [marcar as linhas excluídas](/snippets/delete#how-lightweight-deletes-work-internally-in-clickhouse) (adicionando uma coluna `_row_exists`), o que gera alguma E/S.
