...
export const QuickstartPill = ({ children }) => {
    const path = '/pt-BR/get-started/quickstarts/create-your-first-service-on-cloud';
...
export const HighlightedClickHouse = () => {
    // The brush images are inlined as data URIs so the highlight paints with
    // the heading instead of popping in after two extra network requests.
    return (
    ...
    return (
        <Tabs>
            ...
            <Tab title="Claude Desktop" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claude.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">Adicione a <code>claude_desktop_config.json</code>:</p>
            ...
            <Tab title="Cursor" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-cursor.png">
                <p className="mb-2 text-[#9ca3af] text-[13px]">Adicione a <code>.cursor/mcp.json</code>:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
            <Tab title="Windsurf" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-windsurf.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">Adicione a <code>~/.codeium/windsurf/mcp_config.json</code>:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
        </Tabs>
    );
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      <div className="flex justify-center mb-8">
            <QuickstartPill>Início rápido: <span className="font-medium text-[#2563eb] dark:text-[#FCFF74]">Comece com o Cloud</span></QuickstartPill>
        </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "O que é ClickHouse?", href: "/pt-BR/get-started/about/intro" },
        { label: "Instalação", href: "/pt-BR/get-started/setup/cloud" },
        { label: "Guias de início rápido", href: "/pt-BR/get-started/quickstarts/home" },
        { label: "Conceitos do ClickHouse", href: "/pt-BR/concepts/core-concepts/index" },
        { label: "Conjuntos de dados de exemplo", href: "/pt-BR/get-started/sample-datasets/index" },
        { label: "Guias de migração", href: "/pt-BR/get-started/migrate/overview" },
        { label: "Boas práticas", href: "/pt-BR/concepts/best-practices/index" },
    ]}
        />
        ...
        <svg width="24" height="24" viewBox="0 0 23 26" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="ch-goal-icon">
          ...
          links={[
        { label: "Modelagem de dados", href: "/pt-BR/guides/clickhouse/data-modelling/schema-design" },
        { label: "Otimização de desempenho", href: "/pt-BR/guides/clickhouse/performance-and-monitoring/query-optimization" },
        { label: "ClickHouse Cloud", href: "/pt-BR/products/cloud/guides" },
        { label: "Casos de uso", href: "/pt-BR/guides/use-cases" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "SQL reference", href: "/pt-BR/reference/statements" },
        { label: "Settings", href: "/pt-BR/reference/settings/index" },
        { label: "Functions", href: "/pt-BR/reference/functions/regular-functions/overview" },
        { label: "Engines", href: "/pt-BR/reference/engines/engines" },
        { label: "System tables", href: "/pt-BR/reference/system-tables" },
        { label: "Formats", href: "/pt-BR/reference/formats/index" },
        { label: "Data types", href: "/pt-BR/reference/data-types/index" }
    ]}
        />
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "chDB", href: "/pt-BR/products/chdb" },
        { label: "ClickHouse Cloud", href: "/pt-BR/products/cloud/getting-started/cloud-get-started" },
        { label: "ClickStack", href: "/pt-BR/clickstack" },
        { label: "Langfuse", href: "https://langfuse.com/docs" },
        { label: "Managed Postgres", href: "/pt-BR/products/managed-postgres/overview" },
        { label: "Kubernetes operator", href: "/pt-BR/products/kubernetes-operator/overview" },
    ]}
        />
      </div>
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              { label: "Boas práticas para organizar dados para analytics e crescimento", href: "/pt-BR/guides/clickhouse/data-modelling/schema-design" },
              { label: "Formas de consultar grandes conjuntos de dados em tempo real", href: "/pt-BR/get-started/use-cases/real-time-analytics" },
              { label: "Como criar dashboards, alertas e funcionalidades orientadas por eventos na plataforma", href: "/pt-BR/get-started/use-cases/data-warehousing" },
              { label: "Dicas para manter os custos baixos sem comprometer o desempenho", href: "/pt-BR/concepts/best-practices/index" },
          ]}
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="Plataforma de engenharia de LLM de código aberto para observabilidade, métricas, avaliações e gerenciamento de prompts." href="https://langfuse.com/docs" showArrow />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="Operator para Kubernetes" description="Automatiza a implantação, a configuração e o gerenciamento de clusters do ClickHouse e ClickHouse Keeper no Kubernetes." href="/pt-BR/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="Um banco de dados in-process rápido, confiável e escalável. Experimente o poder do ClickHouse in-process." href="/pt-BR/products/chdb/index" showArrow />
        </div>
      </div>
