...
Agora podemos alimentar outro banco de dados OLTP com o arquivo [dump.sql](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/dump.sql):
