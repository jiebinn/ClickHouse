...
Vamos usar some&#95;data [table](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/some_data.sql) e [data](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/some_data.tsv) para demonstração; sinta-se à vontade para reproduzir isso na sua instância do ClickHouse.
...
Isso criará o arquivo [data.clickhouse](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.clickhouse) no formato Native.
...
Isso gerará o arquivo [data.binary](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.binary) em formato binário de linhas.
...
Para importar dados de um [arquivo no formato MessagePack](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.msgpk):
...
Para trabalhar com [Protocol Buffers](/pt-BR/reference/formats/Protobuf/Protobuf), primeiro precisamos definir um [arquivo de esquema](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/schema.proto):
...
Outro formato popular de serialização binária compatível com o ClickHouse é o [Cap&#39;n Proto](https://capnproto.org/). Assim como no formato `Protobuf`, precisamos definir um arquivo de esquema ([`schema.capnp`](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/schema.capnp)) no nosso exemplo:
