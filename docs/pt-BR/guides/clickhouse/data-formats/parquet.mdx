...
Antes de carregar os dados, podemos usar a função [file()](/pt-BR/reference/functions/regular-functions/files#file) para explorar a estrutura de um [arquivo Parquet de exemplo](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.parquet):
