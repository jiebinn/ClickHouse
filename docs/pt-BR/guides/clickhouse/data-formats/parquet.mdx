...
Antes de carregar os dados, podemos usar a função [file()](/pt-BR/reference/functions/regular-functions/files#file) para explorar a estrutura de um [arquivo Parquet de exemplo](/pt-BR/assets/data.parquet):
