...
Às vezes, para economizar espaço, os arquivos JSON são codificados como arrays em vez de objetos. Nesse caso, lidamos com uma [lista de arrays JSON](/pt-BR/assets/arrays.jsonl):
