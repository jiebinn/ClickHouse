...
Uma das formas mais comuns de dados JSON é ter uma lista de objetos JSON em um array JSON, como [neste exemplo](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/list.json):
...
Para importar uma lista de objetos JSON, podemos usar o formato [`JSONEachRow`](/pt-BR/reference/formats/JSON/JSONEachRow) (inserindo os dados do arquivo [list.json](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/list.json)):
...
Em alguns casos, a lista de objetos JSON pode ser codificada como propriedades do objeto em vez de elementos do array (consulte [objects.json](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/objects.json), por exemplo):
...
Às vezes, para economizar espaço, os arquivos JSON são codificados como arrays em vez de objetos. Nesse caso, lidamos com uma [lista de arrays JSON](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/arrays.jsonl):
...
Em alguns casos, os dados podem ser codificados em colunas em vez de em linhas. Nesse caso, um objeto JSON pai contém colunas com valores. Veja o [arquivo a seguir](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/columns.json):
...
Um formato mais compacto também é compatível ao trabalhar com um [array de colunas](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/columns-array.json) em vez de um objeto, usando o formato [`JSONCompactColumns`](/pt-BR/reference/formats/JSON/JSONCompactColumns):
...
Nos casos em que lidamos com [objetos JSON aninhados](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/list-nested.json), também podemos definir um esquema explícito e usar tipos complexos ([`Array`](/pt-BR/reference/data-types/array), [`JSON`](/pt-BR/guides/clickhouse/data-formats/json/intro) ou [`Tuple`](/pt-BR/reference/data-types/tuple)) para carregar dados:
...
Podemos nos referir às [chaves JSON aninhadas](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/list-nested.json) ativando a [seguinte opção de configuração](/pt-BR/reference/settings/formats#input_format_import_nested_json):
...
Ainda podemos inserir os [dados JSON originais](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/list.json), com 3 colunas, nesta tabela:
...
Para importar dados em BSON, usamos o formato [BSONEachRow](/pt-BR/reference/formats/BSONEachRow). Vamos importar dados [deste arquivo BSON](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.bson):
