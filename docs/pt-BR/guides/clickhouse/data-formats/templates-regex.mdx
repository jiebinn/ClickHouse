...
Suponha que queiramos importar dados do seguinte [arquivo de log](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/error.log):
...
Para importar dados usando um determinado template, precisamos salvar nossa string de template em um arquivo ([row.template](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/row.template), no nosso caso):
...
[Template do conjunto de resultados](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/output.results), que define o layout de todo o conjunto de resultados:
...
Aqui, `rows_read` e `time` são métricas do sistema disponíveis para cada requisição. Já `data` representa as linhas geradas (`${data}` deve sempre aparecer como o primeiro placeholder neste arquivo), com base em um [**arquivo de template de linha**](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/output.rows):
...
Os resultados baseados em Template também podem ser exportados para arquivos usando a cláusula [`INTO OUTFILE`](/pt-BR/reference/statements/select/into-outfile). Vamos gerar arquivos HTML com base nos formatos [resultset](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/html.results) e [row](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/html.row) fornecidos:
...
O formato [Regexp](/pt-BR/reference/formats/Regexp) atende a casos mais sofisticados em que os dados de entrada precisam ser processados de forma mais complexa. Vamos processar nosso arquivo de exemplo [error.log](/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/error.log), mas, desta vez, capturar o nome do arquivo e o protocolo para salvá-los em colunas separadas. Primeiro, vamos preparar uma nova tabela para isso:
