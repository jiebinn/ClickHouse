...
Para importar dados do [arquivo CSV](/pt-BR/assets/data_small.csv) para a tabela `sometable`, podemos passar nosso arquivo diretamente para o clickhouse-client:
...
Suponha que nosso [arquivo CSV tenha cabeçalhos](/pt-BR/assets/data_small_headers.csv):
...
O [arquivo](/pt-BR/assets/data_small.csv) tem 1 mil linhas, mas o ClickHouse carregou apenas 990, já que solicitamos que as 10 primeiras fossem ignoradas.
...
O formato de dados separados por tabulação é amplamente utilizado como formato de intercâmbio de dados. Para carregar dados de um [arquivo TSV](/pt-BR/assets/data_small.tsv) no ClickHouse, usa-se o formato [TabSeparated](/pt-BR/reference/formats/TabSeparated/TabSeparated):
...
Esse formato incluirá duas linhas de cabeçalho: uma com os nomes das colunas e outra com os tipos das colunas. Isso permitirá que o ClickHouse (e outros aplicativos) identifiquem os tipos das colunas ao carregar dados de [arquivos desse tipo](/pt-BR/assets/data_csv_types.csv):
...
Agora podemos carregar os dados do nosso [arquivo](/pt-BR/assets/data_small_custom.txt) com formatação personalizada:
