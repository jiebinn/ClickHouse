...
<Steps>
  <Step>
    #### <TrackedLink href={'/pt-BRhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/examples/jvm-metrics-dashboard.json'} download="jvm-metrics-dashboard.json" eventName="docs.kafka_metrics_monitoring.dashboard_download">Baixar</TrackedLink> a configuração do dashboard
  </Step>
