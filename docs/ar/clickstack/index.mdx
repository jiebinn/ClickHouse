...
export const INFRA = [
  ...
  { title: 'سجلات المضيف',     img: '/images/logo-hostlogs.svg',            href: '/clickstack/integration-examples/host-logs' },
  { title: 'Systemd',       img: '/images/systemd-logomark.svg',               href: '/clickstack/integration-examples/systemd' },
  { title: 'مقاييس JVM',   img: '/images/logo-java.svg',                 href: '/clickstack/integration-examples/jvm-metrics' },
  { title: 'تتبعات Node.js',img: '/images/logo-nodejs.svg',               href: '/clickstack/integration-examples/nodejs-traces' },
];

export const DATABASES = [
  { title: 'سجلات PostgreSQL',    img: '/images/logo-postgres.svg',  href: '/clickstack/integration-examples/postgres-logs' },
  { title: 'مقاييس PostgreSQL', img: '/images/logo-postgres.svg',  href: '/clickstack/integration-examples/postgres-metrics' },
  { title: 'MySQL',              img: '/images/logo-mysql.svg',     href: '/clickstack/integration-examples/mysql' },
  { title: 'سجلات Redis',         img: '/images/icons/redis-logo.svg',          href: '/clickstack/integration-examples/redis-logs' },
  { title: 'مقاييس Redis',      img: '/images/icons/redis-logo.svg',          href: '/clickstack/integration-examples/redis-metrics' },
  { title: 'MongoDB',            img: '/images/mongodb-logo.svg',        href: '/clickstack/integration-examples/mongodb-logs' },
  { title: 'سجلات Kafka',         img: '/images/kafka-logo.svg',  darkImg: '/images/kafka-logo-dark.svg',  href: '/clickstack/integration-examples/kafka-logs' },
  { title: 'مقاييس Kafka',      img: '/images/kafka-logo.svg',  darkImg: '/images/kafka-logo-dark.svg',  href: '/clickstack/integration-examples/kafka-metrics' },
  { title: 'سجلات Nginx',         img: '/images/logo-nginx.svg',     href: '/clickstack/integration-examples/nginx-logs' },
  { title: 'تتبعات Nginx',       img: '/images/logo-nginx.svg',     href: '/clickstack/integration-examples/nginx-traces' },
