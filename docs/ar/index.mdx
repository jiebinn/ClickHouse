...
export const QuickstartPill = ({ children }) => {
    const path = '/ar/get-started/quickstarts/create-your-first-service-on-cloud';
    ...
    return (
        <Tabs>
            ...
            <Tab title="Claude Desktop" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-claude.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">أضف إلى <code>claude_desktop_config.json</code>:</p>
            ...
            <Tab title="Windsurf" icon="https://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/logo-windsurf.svg">
                <p className="mb-2 text-[#9ca3af] text-[13px]">أضف إلى <code>~/.codeium/windsurf/mcp_config.json</code>:</p>
                <CodeBlock language="json">{jsonConfig}</CodeBlock>
            </Tab>
        </Tabs>
    );
  ...
  <div className="relative">
    ...
    <div className="relative z-10 px-0 py-16 lg:py-12 lg:pb-40 max-w-6xl mx-auto">
      <div className="flex justify-center mb-8">
            <QuickstartPill>البدء السريع: <span className="font-medium text-[#2563eb] dark:text-[#FCFF74]">ابدأ مع Cloud</span></QuickstartPill>
        </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mt-24">
        ...
        { label: "Quickstarts", href: "/ar/get-started/quickstarts/home" },
        { label: "مفاهيم ClickHouse", href: "/ar/concepts/core-concepts/index" },
        { label: "مجموعات البيانات التجريبية", href: "/ar/get-started/sample-datasets/index" },
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256" className="ch-goal-icon">
          ...
          links={[
        { label: "chDB", href: "/ar/products/chdb" },
      ...
      <div className="space-y-4 mt-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <div className="col-span-2">
            <HeroCard
              ...
              { label: "أفضل الممارسات لتنظيم البيانات من أجل التحليلات والنمو", href: "/ar/guides/clickhouse/data-modelling/schema-design" },
              { label: "طرق الاستعلام عن مجموعات البيانات الكبيرة في الوقت الفعلي", href: "/ar/get-started/use-cases/real-time-analytics" },
              { label: "كيفية بناء لوحات معلومات وتنبيهات وميزات مدفوعة بالأحداث اعتمادًا عليها", href: "/ar/get-started/use-cases/data-warehousing" },
              { label: "نصائح للحفاظ على انخفاض التكاليف مع بقاء الأداء مرتفعًا", href: "/ar/concepts/best-practices/index" },
          ]}
            />
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <HeroCard filename="thumbnail-langfuse-light.webp" title="LangFuse" description="منصة مفتوحة المصدر لهندسة نماذج اللغة الكبيرة من أجل observability والمقاييس والتقييمات وإدارة الموجّهات." href="https://langfuse.com/docs" showArrow />

          <HeroCard filename="thumbnail-kubernetes-light.webp" title="مشغّل Kubernetes" description="يؤتمت نشر مجموعات ClickHouse وClickHouse Keeper على Kubernetes وتهيئتها وإدارتها." href="/ar/products/kubernetes-operator/overview" showArrow />

          <HeroCard filename="thumbnail-chdb-light.webp" title="chDB" description="قاعدة بيانات سريعة وموثوقة وقابلة للتوسع تعمل ضمن العملية. اختبر قوة ClickHouse ضمن العملية." href="/ar/products/chdb/index" showArrow />
        </div>
      </div>
