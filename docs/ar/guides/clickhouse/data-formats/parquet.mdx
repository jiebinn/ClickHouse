...
قبل تحميل البيانات، يمكننا استخدام الدالة [file()](/ar/reference/functions/regular-functions/files#file) لاستعراض بنية [ملف Parquet تجريبي](/ar/assets/data.parquet):
