...
قبل تحميل البيانات، يمكننا استخدام الدالة [file()](/ar/reference/functions/regular-functions/files#file) لاستعراض بنية [ملف Parquet تجريبي](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.parquet):
