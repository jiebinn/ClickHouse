...
للاستيراد من [ملف Avro](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.avro)، ينبغي استخدام تنسيق [Avro](/ar/reference/formats/Avro/Avro) في تعليمة `INSERT`:
...
تنسيق عمودي آخر هو [Apache Arrow](https://arrow.apache.org/)، ويدعمه ClickHouse أيضًا في الاستيراد والتصدير. ولاستيراد البيانات من [ملف Arrow](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.arrow)، نستخدم تنسيق [Arrow](/ar/reference/formats/Arrow/Arrow):
...
يُعد تنسيق [Apache ORC](https://orc.apache.org/) تنسيقَ تخزينٍ عموديًا يُستخدم عادةً مع Hadoop. يدعم ClickHouse استيراد [بيانات ORC](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.orc) وتصديرها باستخدام [تنسيق ORC](/ar/reference/formats/ORC):
