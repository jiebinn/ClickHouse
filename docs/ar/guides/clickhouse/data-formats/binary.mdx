...
سنستخدم جدول some&#95;data [table](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/some_data.sql) وملف [data](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/some_data.tsv) للتوضيح، ويمكنك إعادة تطبيق ذلك على مثيل ClickHouse لديك.
...
سيؤدي هذا إلى إنشاء ملف [data.clickhouse](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.clickhouse) بتنسيق Native.
...
سيؤدي ذلك إلى إنشاء ملف [data.binary](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.binary) بتنسيق ثنائي للصفوف.
...
لاستيراد البيانات من [ملف بتنسيق MessagePack](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/data.msgpk):
...
للعمل مع [Protocol Buffers](/ar/reference/formats/Protobuf/Protobuf)، نحتاج أولًا إلى تعريف [ملف المخطط](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/schema.proto):
...
يحفظ هذا البيانات في ملف [proto.bin](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/proto.bin). ويدعم ClickHouse أيضًا استيراد بيانات Protobuf، بالإضافة إلى الرسائل المتداخلة. يُستحسن استخدام [ProtobufSingle](/ar/reference/formats/Protobuf/ProtobufSingle) للعمل مع رسالة Protocol Buffer واحدة (لن تُضمَّن محددات الطول في هذه الحالة).
...
من تنسيقات التسلسل الثنائي الشائعة الأخرى التي يدعمها ClickHouse تنسيق [Cap&#39;n Proto](https://capnproto.org/). وكما هو الحال مع تنسيق `Protobuf`، علينا تعريف ملف المخطط ([`schema.capnp`](/arhttps://clickhouse-docs-assets.s3.us-east-1.amazonaws.com/schema.capnp)) في مثالنا:
