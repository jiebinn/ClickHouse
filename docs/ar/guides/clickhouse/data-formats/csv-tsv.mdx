...
لاستيراد البيانات من [ملف CSV](/ar/assets/data_small.csv) إلى الجدول `sometable`، يمكننا توجيه ملفنا مباشرةً إلى clickhouse-client:
...
لنفترض أن [ملف CSV يتضمن صف العناوين](/ar/assets/data_small_headers.csv):
...
يحتوي [الملف](/ar/assets/data_small.csv) على 1k صف، لكن ClickHouse حمّل 990 صفًا فقط لأننا طلبنا تخطي أول 10 صفوف.
...
يُستخدم تنسيق البيانات المفصول بعلامات الجدولة على نطاق واسع كتنسيق لتبادل البيانات. لتحميل البيانات من [ملف TSV](/ar/assets/data_small.tsv) إلى ClickHouse، يُستخدم التنسيق [TabSeparated](/ar/reference/formats/TabSeparated/TabSeparated):
...
سيتضمن هذا التنسيق صفَّي ترويسة: أحدهما يتضمن أسماء الأعمدة، والآخر أنواع الأعمدة. يتيح ذلك لـ ClickHouse (وللتطبيقات الأخرى) التعرّف على أنواع الأعمدة عند تحميل البيانات من [ملفات مثل هذه](/ar/assets/data_csv_types.csv):
...
الآن يمكننا تحميل البيانات من [ملف](/ar/assets/data_small_custom.txt) بتنسيقنا المخصّص:
