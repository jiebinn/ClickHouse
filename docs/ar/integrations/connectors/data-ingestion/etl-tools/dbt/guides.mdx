...
قدّم ClickHouse 22.8 [عمليات الحذف خفيفة الوزن](/snippets/delete)، وقدّم ClickHouse 25.7 [عمليات التحديث خفيفة الوزن](/ar/reference/statements/update). ومع إتاحة هذه الميزات، تصبح التعديلات الناتجة عن استعلامات التحديث المفردة فورية من منظور المستخدم، حتى عند تطبيقها ماديًا بشكل غير متزامن.
