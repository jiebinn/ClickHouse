...
<Image size="md" img="/images/integrations/data-visualization/rocketbi_07.webp" alt="عنصر تحكم في نطاق التاريخ مع مرشحات أُعيدت تسميتها وجاهز للحفظ في لوحة المعلومات" border />
...
<Image size="md" img="/images/integrations/data-visualization/rocketbi_10.webp" alt="واجهة علامة التبويب Chart Control التي تعرض خيارات ضبط التصور" border />

<br />

اسحب عنصر تحكم بالمقاييس وأفلِته في Value Field

<Image size="md" img="/images/integrations/data-visualization/rocketbi_11.webp" alt="إضافة عنصر التحكم بالمقاييس إلى حقل القيمة في المخطط الدائري" border />
...
<Image size="md" img="/images/integrations/data-visualization/rocketbi_12.webp" alt="لوحة إعدادات المخطط التي تعرض خيارات تخصيص المخطط الدائري" border />
...
<Image size="md" img="/images/integrations/data-visualization/rocketbi_14.webp" alt="عرض لوحة المعلومات ويظهر فيها المخطط الدائري المضاف حديثًا مع عناصر تحكم أخرى" border />
