...
<Image img="/images/bestpractices/async_inserts.png" size="lg" alt="Inserções assíncronas" />
...
* Um número máximo de consultas de insert é acumulado ([`async_insert_max_query_number`](/pt-BR/reference/settings/session-settings#async_insert_max_query_number), padrão de 450).
