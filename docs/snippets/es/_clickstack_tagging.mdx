...
<Image img="/images/use-cases/observability/clickstack-tags-search.png" alt="Etiquetas en búsquedas guardadas" size="md" border />

También puedes seleccionar varias etiquetas para filtrar y ver elementos de distintas categorías:

<Image img="/images/use-cases/observability/clickstack-tags-dashboard.png" alt="Varias etiquetas seleccionadas en el dashboard" size="md" border />