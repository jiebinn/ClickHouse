...
<Accordion title="Conectarse a la consola SQL">
  ...
  <Image img="/images/_snippets/cloud-connect-to-sql-console.png" alt="Conectarse a la consola SQL" size="lg" force border />

  Esto te redirigirá a la consola SQL.

  <Image img="/images/_snippets/createservice8.png" alt="Consola SQL" size="lg" force border />
</Accordion>