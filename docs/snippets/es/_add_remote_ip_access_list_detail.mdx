...
<Accordion title="Gestiona tu IP Access List">
  ...
  <Image size="md" img="/images/_snippets/ip-allow-list-check-list.png" alt="Comprueba si el servicio permite tráfico desde tu dirección IP en la IP Access List" border />
  ...
  <Image size="md" img="/images/_snippets/ip-allow-list-add-current-ip.png" alt="Agrega tu dirección IP actual a la IP Access List en ClickHouse Cloud" border />
</Accordion>