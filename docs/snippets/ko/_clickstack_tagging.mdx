...
<Image img="/images/use-cases/observability/clickstack-tags-search.png" alt="저장된 검색의 태그" size="md" border />

여러 태그를 선택해 서로 다른 범주의 항목을 필터링하여 볼 수도 있습니다:

<Image img="/images/use-cases/observability/clickstack-tags-dashboard.png" alt="대시보드에서 여러 태그 선택" size="md" border />