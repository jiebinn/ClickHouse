...
<Steps>
  <Step>
    ...
    <Image size="lg" img="/images/_snippets/mysql1.png" alt="Экран учетных данных ClickHouse Cloud с раскрывающимся списком выбора интерфейса MySQL" border />
  </Step>
  ...
  <Step>
    ...
    <Image size="lg" img="/images/_snippets/mysql2.png" alt="Переключатель включения интерфейса MySQL в ClickHouse Cloud и сведения о подключении" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/_snippets/mysql3.png" alt="Экран подключения сервиса ClickHouse Cloud с выделенной опцией Connect" border />
  </Step>
  ...
  <Step>
    ...
    <Image size="md" img="/images/_snippets/mysql4.png" alt="Экран подключения ClickHouse Cloud с выбранной опцией MySQL" border />
  </Step>
...
<Image size="md" img="/images/_snippets/mysql5.png" alt="Экран подключения ClickHouse Cloud с включенным интерфейсом MySQL, показывающий сведения о подключении" border />
