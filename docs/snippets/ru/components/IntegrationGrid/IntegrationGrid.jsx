export const IntegrationGrid = () => {
  ...
  function getSectionDescription(type) {
    const descriptions = {
      ClickPipes: "ClickPipes — это движок интеграции, который делает приём огромных объёмов данных из разнообразных источников таким же простым, как нажатие нескольких кнопок.",
      "Data ingestion": "Оптимизируйте конвейеры данных с ClickHouse! Бесшовные интеграции обеспечивают эффективную ингестию данных и оптимизируют аналитику в реальном времени.",
      "Data visualization": "Раскройте потенциал ваших данных! Интеграции ClickHouse расширяют возможности визуализации, делая аналитику более наглядной и практически применимой.",
      "SQL client": "Обращайтесь к базам данных ClickHouse и выполняйте запросы с помощью привычных инструментов и интерфейсов SQL-клиентов.",
      "Language client": "Работайте на привычном языке! Интеграции языковых клиентов ClickHouse обеспечивают удобный доступ к данным на множестве языков программирования.",
      "AI/ML": "Используйте ClickHouse для задач машинного обучения и ИИ с интегрированными инструментами и фреймворками ML.",
      "Data management": "Управляйте, отслеживайте и оптимизируйте данные ClickHouse с помощью специализированных инструментов управления.",
      "Data integration": "Интегрируйте ClickHouse с существующей инфраструктурой данных и рабочими процессами.",
      "Security governance": "Внедряйте фреймворки безопасности и управления для вашей среды ClickHouse."
    }
    return descriptions[type] || "Интегрируйте ClickHouse со специализированными инструментами и сервисами."
  }
      ...
      const fetchIntegrations = async () => {
        ...
        try {
          ...
          const timeoutId = setTimeout(() => {
            controller.abort()
            console.log("Тайм-аут запроса к CMS после 8 секунд")
          }, 8000)
          ...
          cacheIntegrations(transformedData)
          setError(null)
          console.log("Успешно обновлено актуальными данными CMS")
        } catch (cmsErr) {
  ...
  if (loading) {
    return (
      <div className="text-center py-12">
        <p className="text-gray-600 dark:text-gray-400">Загрузка интеграций...</p>
      </div>
    )
  }
  ...
  if (error) {
    return (
      <div className="text-center py-12">
        <p className="text-red-600 dark:text-red-400">Не удалось загрузить интеграции: {error}</p>
  ...
  if (integrations.length === 0) {
    return (
      <div className="text-center py-12">
        <p className="text-gray-600 dark:text-gray-400">Интеграции не найдены.</p>
      </div>
    )
  }
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="my-8 flex justify-center items-center" style={{ margin: "2rem 0 12px 0" }}>
          <div className="relative w-full" style={{ maxWidth: "500px" }}>
            ...
            <input
              type="text"
              placeholder="Поиск по интеграции"
              value={searchTerm}
        ...
        {filteredIntegrations.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-600 dark:text-gray-400 text-lg">Интеграции, соответствующие вашим критериям, не найдены.</p>
          </div>
        )}
      </div>
    </>
