...
<Image img="/images/integrations/data-ingestion/clickpipes/object-storage/azure-blob-storage/cp_step2.png" alt="Заполните сведения о подключении" size="lg" border />
