...
<Accordion title="Подключение к SQL-консоли">
  ...
  <Image img="/images/_snippets/cloud-connect-to-sql-console.png" alt="Подключение к SQL-консоли" size="lg" force border />

  Вы будете перенаправлены в SQL-консоль.

  <Image img="/images/_snippets/createservice8.png" alt="SQL-консоль" size="lg" force border />
</Accordion>