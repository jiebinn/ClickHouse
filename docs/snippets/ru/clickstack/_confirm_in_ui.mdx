...
<Image img="/images/use-cases/observability/clickstack-cloud-first-time.png" size="lg" alt="Запустить ClickStack" border />
...
<Image img="/images/use-cases/observability/clickstack-search.png" size="lg" alt="Представление поиска ClickStack с появляющимися журналами" />
