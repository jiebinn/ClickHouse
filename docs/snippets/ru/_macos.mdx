...
<Steps>
  ...
  <Step>
    ...
    <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/dev-verification-error.png" size="sm" alt="Диалог ошибки проверки разработчика в macOS" border />
    ...
    2. Перейдите в раздел **Privacy &amp; Security**:
       ...
       <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-default-view.png" size="md" alt="Стандартный вид настроек Privacy & Security в macOS" border />
    ...
    4. Нажмите **Allow Anyway**.
       ...
       <Image img="/images/knowledgebase/fix-the-developer-verification-error-in-macos/privacy-and-security-screen-allow-anyway.png" size="md" alt="Настройки Privacy & Security в macOS с кнопкой Allow Anyway" border />
