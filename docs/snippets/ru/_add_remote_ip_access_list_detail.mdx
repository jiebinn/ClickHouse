...
<Accordion title="Управление IP Access List">
  ...
  <Image size="md" img="/images/_snippets/ip-allow-list-check-list.png" alt="Проверьте, разрешён ли трафик с вашего IP-адреса в IP Access List сервиса" border />
  ...
  <Image size="md" img="/images/_snippets/ip-allow-list-add-current-ip.png" alt="Добавьте свой текущий IP-адрес в IP Access List в ClickHouse Cloud" border />
</Accordion>