...
<Accordion title="Gérer votre IP Access List">
  ...
  <Image size="md" img="/images/_snippets/ip-allow-list-check-list.png" alt="Vérifiez si le service autorise le trafic provenant de votre adresse IP dans l’IP Access List" border />
  ...
  <Image size="md" img="/images/_snippets/ip-allow-list-add-current-ip.png" alt="Ajoutez votre adresse IP actuelle à l’IP Access List dans ClickHouse Cloud" border />
</Accordion>