...
<img src="/images/_snippets/cloud-connect-button.png" alt="ClickHouse Cloud service connect button" width="500px"/>

Choose **Native**, and the details are available in an example `clickhouse-client` command.

<img src="/images/_snippets/connection-details-native.png" alt="ClickHouse Cloud Native TCP connection details" width="500px"/>
