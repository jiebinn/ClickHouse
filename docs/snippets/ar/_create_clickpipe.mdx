...
<Steps>
  <Step>
    ...
    **1.** في ClickHouse Cloud، اختر **مصادر البيانات** من قائمة التنقل الرئيسية، ثم انقر على **Create ClickPipe**.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step0.png" alt="اختر الواردات" size="lg" border />
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step3_object_storage.png" alt="عيّن تنسيق البيانات والموضوع" size="lg" border />
  </Step>
  ...
  <Step>
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a.png" alt="عيّن الجدول والمخطط والإعدادات" size="lg" border />

    يمكنك أيضًا تخصيص الإعدادات المتقدمة باستخدام عناصر التحكم المتاحة

    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step4a3.png" alt="عيّن عناصر التحكم المتقدمة" size="lg" border />
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step4b.png" alt="استخدم جدولًا موجودًا" size="lg" border />
  ...
  <Step>
    ...
    * `Only destination table`: أذونات `INSERT` على جدول الوجهة فقط.
    ...
    <Image img="/images/integrations/data-ingestion/clickpipes/cp_step5.png" alt="الأذونات" size="lg" border />
  </Step>
