export const kbIndex = {
  ...
  articles: [
    ...
    },
    {
      ...
      description:
        "تشرح هذه المقالة كيفية حل خطأ DB::Exception المتعلق بتقاطع الأجزاء في ClickHouse، والذي يحدث في الغالب بسبب حالة تسابق أو تدخل يدوي في بيانات ZooKeeper.",
    ...
    },
    {
      ...
      description: "تعرّف على الفروق الجوهرية بين إصدارات ClickHouse الرسمية وإصدارات الجهات الخارجية، بما في ذلك التحديثات والتوافق واعتبارات الأمان.",
    ...
    },
    {
      ...
      title: "هل يمتلك ClickHouse محسِّنًا قائمًا على التكلفة؟",
    ...
    },
    {
      ...
      description: "يدعم ClickHouse طيفًا واسعًا من الاستعلامات الموحدة والهجينة",
    ...
    },
    {
      ...
      description: "يدعم ClickHouse معدلات QPS مرتفعة والتزامن العالي",
    ...
    },
    {
      ...
      description: "تجيب هذه الصفحة عن سؤال دعم ClickHouse للنسخ المتماثل متعدد المناطق",
    ...
    },
    {
      ...
      title: "هل يدعم ClickHouse التحديثات الفورية؟",
      description: "يدعم ClickHouse التحديثات الفورية الخفيفة",
    ...
    },
    {
      ...
      description: "توضح هذه المقالة في قاعدة المعرفة كيفية البحث عن أعداد الأجزاء حسب نوعها - واسعة أو مضغوطة.",
    ...
    },
    {
      ...
      description: "تعرّف على كيفية حل خطأ التحقق من المطوّر في MacOS عند تشغيل أوامر ClickHouse، سواء عبر إعدادات النظام أو الطرفية.",
    ...
    },
    {
      ...
      description: "تعرّف على كيفية تغيير عنوان الفوترة في ClickHouse Cloud.",
    ...
    },
    {
      ...
      title: "كيف أساهم بكود في ClickHouse؟",
    ...
    },
    {
      ...
      description: "تعرّف على كيفية استخدام أداة `clickhouse-local` في ClickHouse لتحويل ملفات Parquet إلى صيغتَي CSV أو JSON بسهولة.",
      href: "/resources/support-center/knowledge-base/data-import-export/parquet-to-csv-json",
      category: "استيراد البيانات وتصديرها",
      tags: ["مصادر البيانات", "صيغ البيانات"]
    },
    {
      ...
      category: "استيراد البيانات وتصديرها",
      tags: ["صيغ البيانات", "تصدير البيانات"]
    },
    {
      ...
      category: "استيراد البيانات وتصديرها",
      tags: ["تصدير البيانات", "صيغ البيانات"]
    },
    {
    ...
    },
    {
      ...
      description: "حلّ خطأ TOO_MANY_PARTS في ClickHouse أثناء تنفيذ `INSERT...SELECT` عبر ضبط إعدادات متقدمة لكتل أكبر وزيادة حدود الأقسام.",
    ...
    },
    {
      ...
      description:
        "راقب عدد التحولات النشطة أو المنتظرة في ClickHouse، لا سيما عند تنفيذ عمليات `ALTER` أو `UPDATE`. استخدم جدول `system.mutations` لتتبع التحولات.",
    ...
    },
    {
      ...
      title: "كيف أضمن اتساق قراءة البيانات في ClickHouse؟",
      description: "تعرّف على كيفية ضمان اتساق البيانات عند القراءة من ClickHouse، سواء كنت متصلاً بالعقدة ذاتها أو بعقدة عشوائية.",
    ...
    },
    {
      ...
      description: "تعرّف على كيفية حساب نسبة القيم الفارغة أو الصفرية في كل عمود من أعمدة جدول ClickHouse لتحسين تسلسل الأعمدة المتفرقة.",
    ...
    },
    {
      ...
      title: "كيف أتحقق من المستخدمين المعيّنين للأدوار والعكس بالعكس؟",
      ...
      category: "الأمان والتحكم في الوصول",
      tags: ["إدارة الخادم", "جداول النظام", "إدارة Cloud"]
    },
    {
    ...
    },
    {
      ...
      title: "كيف أتحقق من حالة خدمة ClickHouse Cloud الخاصة بي؟",
    ...
    },
    {
      ...
      description: "تعرّف على كيفية التحقق من استخدام الإسقاط في استعلامات ClickHouse عبر الاختبار ببيانات نموذجية واستخدام EXPLAIN للتحقق من توظيف الإسقاط.",
      href: "/resources/support-center/knowledge-base/materialized-views/projection-example",
      category: "طرق العرض المادية والإسقاطات",
      tags: ["نمذجة البيانات"]
    },
    {
    ...
    },
    {
      ...
      description: "مثال بسيط يوضح كيفية استخدام array join لاستخراج السمات المتغيرة والاستعلام عنها باستخدام مفاتيح وقيم الـ map",
    ...
    },
    {
      ...
      title: "كيفية استخدام العروض ذات المعاملات في ClickHouse",
      description: "تعرّف على كيفية إنشاء العروض ذات المعاملات والاستعلام عنها في ClickHouse لتقسيم البيانات ديناميكيًا بناءً على معاملات وقت الاستعلام.",
    ...
    },
    {
      ...
      title: "كيفية استخدام أمر exchange للتبديل بين الجداول",
      description: "كيفية استخدام أمر exchange للتبديل بين الجداول",
    ...
    },
    {
      ...
      title: "كيفية التحقق من أن استعلامين يُعيدان مجموعتَي نتائج متطابقتين",
      description: "تعرّف على كيفية التحقق من أن استعلامَي ClickHouse ينتجان مجموعتَي نتائج متطابقتين باستخدام دوال التجزئة وأساليب المقارنة.",
    ...
    },
    {
      ...
      description: "تعرّف على كيفية التحقق مما إذا كانت ذاكرة التخزين المؤقت للاستعلامات مُستخدَمة في ClickHouse باستخدام سجلات التتبع في `clickhouse-client` أو أوامر SQL.",
    ...
    },
    {
      ...
      description: "استكشاف مشكلات الوصول إلى خدمات ClickHouse Cloud وإصلاحها، بما في ذلك ضبط قائمة الوصول بعناوين IP",
    ...
    },
    {
      ...
      title: "تحديد الاستعلامات المُكلفة حسب استخدام الذاكرة في ClickHouse",
      description: "تعرّف على كيفية استخدام جدول `system.query_log` للعثور على الاستعلامات الأكثر استهلاكًا للذاكرة في ClickHouse، مع أمثلة لإعدادات الـ cluster والإعدادات المستقلة.",
    ...
    },
    {
      ...
      description: "تعرّف على كيفية استيراد كائنات مصفوفة JSON إلى ClickHouse وتنفيذ استعلامات متقدمة باستخدام دوال JSON وعمليات المصفوفات.",
    ...
    },
    {
      ...
      description: "\"استيراد GeoJSON مع مصفوفة كائنات متداخلة بعمق\"",
    ...
    },
    {
      ...
      title: "تحسين أداء البحث في Map بـ ClickHouse",
      description: "تعرّف على كيفية تحسين عمليات البحث في أعمدة Map بـ ClickHouse لتحقيق أداء استعلام أفضل عبر تحويل مفاتيح محددة إلى أعمدة مستقلة.",
    ...
    },
    {
      ...
      description: "تجيب هذه الصفحة على سؤال ما إذا كان بالإمكان حذف السجلات القديمة من جدول ClickHouse",
    ...
    },
    {
      ...
      title: "هل يمكن نشر ClickHouse مع فصل التخزين عن الحوسبة؟",
      description: "تقدم هذه الصفحة إجابة عن إمكانية نشر ClickHouse مع فصل التخزين عن الحوسبة",
    ...
    },
    {
      ...
      description: "مثال موجز على كيفية استخراج الأنواع الأساسية من JSON",
    ...
    },
    {
      ...
      description: "تعرّف على كيفية تشغيل خدمة ClickHouse Cloud وإيقافها واستئنافها باستخدام نقاط نهاية API وأوامر cURL.",
      href: "/resources/support-center/knowledge-base/cloud-services/clickhouse-cloud-api-usage",
      category: "Cloud",
      tags: ["إدارة Cloud", "الأدوات والمرافق"]
    },
    {
      id: "monitoring-debugging/mapping-of-system-metrics-to-prometheus-metrics",
      title: "ربط المقاييس المستخدمة في system.dashboards بمقاييس Prometheus في `system.custom_metrics`",
      description: "ربط المقاييس المستخدمة في system.dashboards بمقاييس Prometheus في system.custom_metrics",
    ...
    },
    {
      ...
      title: "ربط مجموعات أمان Windows Active Directory بأدوار ClickHouse",
      description: "مثال على ربط مجموعات أمان Windows Active Directory بأدوار ClickHouse",
    ...
    },
    {
      ...
      title: "خطأ فشل مصادقة ODBC عند استخدام موصّل Power BI لـ ClickHouse",
      description: "خطأ فشل مصادقة ODBC عند استخدام موصّل Power BI لـ ClickHouse",
      href: "/resources/support-center/knowledge-base/integrations/ODBC-authentication-failed-error-using-PowerBI-CH-connector",
      category: "التكاملات ومكتبات العملاء",
      tags: ["العملاء والواجهات الأصلية", "الأخطاء والاستثناءات"]
    },
    {
      id: "monitoring-debugging/profiling-clickhouse-with-llvm-xray",
      title: "تحليل أداء ClickHouse باستخدام XRay من LLVM",
      description: "تعرّف على كيفية تحليل أداء ClickHouse باستخدام أداة التوصيف XRay من LLVM، وتصوير آثار التنفيذ، وتحليل الأداء.",
      href: "/resources/support-center/knowledge-base/monitoring-debugging/profiling-clickhouse-with-llvm-xray",
      category: "المراقبة وتصحيح الأخطاء",
      tags: ["الأداء والتحسينات", "الأدوات والمرافق"]
    },
    {
    ...
    },
    {
      ...
      description: 'Learn about ماذا يعني "ClickHouse"؟',
    ...
    },
    {
      ...
      description: "يناقش الفروق بين OPTIMIZE FINAL وFINAL، ومتى ينبغي استخدام كلٍّ منهما أو تجنّبه.",
    ...
    },
    {
      ...
      description:
        "تُطبَّق قواعد TTL في ClickHouse في وقت لاحق، ويمكنك التحكّم في وقت تنفيذها باستخدام الإعداد `merge_with_ttl_timeout`. تعرّف على كيفية فرض تطبيق قواعد TTL وإدارة الخيوط الخلفية المخصّصة لتنفيذها.",
