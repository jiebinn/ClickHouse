...
<Accordion title="什么是 ClickPipes 副本？">
  ...
  <Image img="/images/cloud/manage/jan2025_faq/external_clickpipes_pricing_faq_1.png" size="lg" alt="ClickPipes 副本 - 流式 ClickPipes" border force />
  ...
  <Image img="/images/cloud/manage/jan2025_faq/external_clickpipes_pricing_faq_2.png" size="lg" alt="ClickPipes 副本 - 对象存储 ClickPipes" border force />
</Accordion>
...
<Accordion title="我需要多少个 ClickPipes 副本？">
  ...
  <Image img="/images/cloud/manage/jan2025_faq/external_clickpipes_pricing_faq_3.png" size="lg" alt="ClickPipes 副本 - 我需要多少个 ClickPipes 副本？" border force />
</Accordion>
