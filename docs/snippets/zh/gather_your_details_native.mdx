...
<img src="/images/_snippets/cloud-connect-button.png" alt="ClickHouse Cloud 服务连接按钮" width="500px" />

选择 **Native**，即可在示例 `clickhouse-client` 命令中查看相关详细信息。

<img src="/images/_snippets/connection-details-native.png" alt="ClickHouse Cloud 原生 TCP 连接详细信息" width="500px" />
