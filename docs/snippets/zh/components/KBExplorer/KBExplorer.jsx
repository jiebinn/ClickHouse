  ...
  const featuredArticles = featured
    .map((f) => {
      ...
      return {
        id: f.id,
        image: f.image,
        href: (article && article.href) || `/zh/resources/support-center/knowledge-base/${f.id}`,
  ...
  return (
    <>
      <div style={{ maxWidth: "1312px", marginLeft: "max(0px, calc((100vw - 1312px) / 2 - 19rem))", marginRight: "auto", paddingLeft: "1.75rem", paddingRight: "1.75rem" }}>
        <div className="my-8">
          {/* 精选文章 section - full width banner image cards */}
          {featuredArticles.length > 0 && (
            <div className="mb-12">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-6">精选文章</h2>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-50 mb-6">浏览文章</h2>
              ...
              {filteredArticles.length > 0 ? (
                ...
                <div className="text-center py-12 flex flex-col items-center">
                  <p className="text-gray-600 dark:text-gray-400 text-lg block">未找到符合条件的文章。</p>
