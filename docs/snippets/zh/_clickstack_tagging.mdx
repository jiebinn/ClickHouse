...
<Image img="/images/use-cases/observability/clickstack-tags-search.png" alt="已保存的搜索中的标签" size="md" border />

您还可以选择多个标签，按不同类别过滤并查看项目：

<Image img="/images/use-cases/observability/clickstack-tags-dashboard.png" alt="仪表盘中选中的多个标签" size="md" border />