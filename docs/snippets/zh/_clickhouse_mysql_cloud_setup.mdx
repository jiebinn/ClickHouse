---
title: ClickHouse MySQL Cloud 配置
---
...
<Steps>
  <Step>
    ...
    <Image size="lg" img="/images/_snippets/mysql1.png" alt="显示 MySQL 接口选择下拉菜单的 ClickHouse Cloud 凭据页面" border />
  </Step>
  ...
  <Step>
    ...
    这将为该服务开放端口 `3306`，并显示 MySQL 连接页面，其中包含你唯一的 MySQL 用户名。

    <Image size="lg" img="/images/_snippets/mysql2.png" alt="ClickHouse Cloud MySQL 接口启用开关和连接详细信息" border />
  ...
  <Step>
    ...
    <Image size="lg" img="/images/_snippets/mysql3.png" alt="突出显示 Connect 选项的 ClickHouse Cloud 服务连接页面" border />
  </Step>

  <Step>
    #### 选择 `MySQL`

    从 `Connect With` 下拉菜单中选择 `MySQL`。

    <Image size="md" img="/images/_snippets/mysql4.png" alt="显示 MySQL 选项选择的 ClickHouse Cloud 连接页面" border />
  </Step>
...
<Image size="md" img="/images/_snippets/mysql5.png" alt="已启用 MySQL 接口并显示连接详细信息的 ClickHouse Cloud 连接页面" border />
