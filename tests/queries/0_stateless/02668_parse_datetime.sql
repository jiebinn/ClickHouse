...
select parseDateTime(''); -- { serverError CANNOT_PARSE_DATETIME }
...
select parseDateTime64(''); -- { serverError CANNOT_PARSE_DATETIME }
select parseDateTime64('2021-01-04 23:12:34.118') = toDateTime64('2021-01-04 23:12:34.118000', 6);
select parseDateTime64('2177-10-09 10:30:10.123') = toDateTime64('2177-10-09 10:30:10.123000', 6);
...
select parseDateTime64('2021-01-04 23:12:34.118', '%Y-%m-%d %H:%i:%s.%f') = toDateTime64('2021-01-04 23:12:34.118000', 6);
...
select parseDateTime64OrNull('2021-01-04 23:12:34.118') = toDateTime64('2021-01-04 23:12:34.118000', 6);
select parseDateTime64OrNull('2021-01-04 23:12:34.118', '%Y-%m-%d %H:%i:%s.%f') = toDateTime64('2021-01-04 23:12:34.118000', 6);
...
select parseDateTime64OrZero('2021-01-04 23:12:34.118') = toDateTime64('2021-01-04 23:12:34.118000', 6);
select parseDateTime64OrZero('2021-01-04 23:12:34.118', '%Y-%m-%d %H:%i:%s.%f') = toDateTime64('2021-01-04 23:12:34.118000', 6);
